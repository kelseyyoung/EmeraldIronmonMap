  ...
  return (
    <>
      ...
      >
        ...
        <DialogContent>
          ...
          <div className="dialog-text">
            ...
            <a
              rel="noreferrer"
              href="https://github.com/kelseyyoung/EmeraldIronmonMap"
              target="_blank"
            >
              Github README
            </a>
      ...
      >
        ...
        <DialogContent>
          <div className="dialog-text">
            See something wrong on the map? Want to suggest a feature? The best
            way to get in touch is to file an issue on{" "}
            <a
              rel="noreferrer"
